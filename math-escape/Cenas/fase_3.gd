...
func _on_hud_time_up() -> void: game_over()
func _on_espinho_morreu() -> void: game_over()
...
func _on_exit_door_player_entered_door() -> void:
	if coletaveis_pegos == target_amount:
		...
		get_tree().change_scene_to_file("res://Cenas/carta_fase_3_screen.tscn")
